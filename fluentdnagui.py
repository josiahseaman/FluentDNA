...
def main():
    ...
    input_files_group = parser.add_argument_group(
                                                "Data Input files",
                                                "Select data files for visualizations"
                                                )
    basic_options_group = parser.add_argument_group(
                                            "Visualization Options", 
                                            "Global options related to generating a visualization"
                                            )
    basic_options_group.add_argument('--quick',
                        action='store_true',
    ...
    input_files_group.add_argument("-f", "--fasta",
                        type=str,
                        help="Path to main FASTA file to process into new visualization.",
                        dest="fasta",
                        widget='FileChooser')
    basic_options_group.add_argument("-o", "--outname",
                        type=str,
    ...
    basic_options_group.add_argument('-s', '--sort_contigs',
                        ...
                        dest="sort_contigs")
    basic_options_group.add_argument('-nc', '--natural_colors',
                        action='store_true',
                        help="Use low contrast, natural colors that are easier on the eyes",
                        dest="low_contrast")
    basic_options_group.add_argument("-l", "--layout",
                        type=str,
    ...
    input_files_group.add_argument("-x", "--extrafastas",
                        nargs='+',
                        type=str,
                        help="Path to secondary FASTA files to process when doing Parallel layout.",
                        dest="extra_fastas",
                        widget='FileChooser')
    basic_options_group.add_argument("-bw", "--base_width",
    ...
    basic_options_group.add_argument("-nt", "--no_titles",
                        action='store_true',
                        help="No gaps for a title.  Useful when combined with separate_translocations",
                        dest="no_titles")
    basic_options_group.add_argument("-nw", "--no_webpage",
                        action='store_true',
                        ...
                        dest="no_webpage")
    basic_options_group.add_argument("-q", "--trial_run",
                        action='store_true',
                        help="Only show the first 1 Mbp.  This is a fast run for testing.",
                        dest="trial_run")
    ### Chain Files
    chain_files_group = parser.add_argument_group(
                                            "Parallel Layout Options", 
    ...
    about_group.add_argument('-n', '--update_name', dest='update_name', help='Query for the name of this program as known to the update server', action='store_true')
    about_group.add_argument('-v', '--version', dest='version', help='Get current version of program.', action='store_true')
