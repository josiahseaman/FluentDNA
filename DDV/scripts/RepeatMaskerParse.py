...
from DNASkittleUtils.Contigs import pluck_contig, just_the_name
...
if __name__ == '__main__':
    # test_reader()
    annotation_file = r'supplemental\RepeatMasker_all_alignment.csv'  # RepeatMasker_all_alignment.csv'  RepeatMasker_chr20_alignment
